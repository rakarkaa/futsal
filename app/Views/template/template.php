        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?php echo base_url() . '/dist/img/hnd.jpg" class="img-circle elevation-2' ?>" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Hidayat Nurwahid</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . '/index.php/Dashboard/daftar' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar User</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . '/index.php/Dashboard/user' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard User</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . '/index.php/Dashboard/mail' ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Email</p>
                                    </a>
                                </li>
